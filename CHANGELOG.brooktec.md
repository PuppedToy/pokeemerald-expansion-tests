...
- PC tab in the generated docs (between Trainers and Mail): a single scrollable, non-paginated grid of your current (non-fainted) box Pokémon — evolution overlay respected — each clickable to open its detail modal (T-009).
