...
| [B-052](B-052-tate-liza-determinism-test-red.md) | Seed-pinned regression tests drift against regenerated base-data (Tate & Liza determinism + B-024 evolution-mail interaction) | open | major | 0.6.0 |  | randomizer/__tests__/integration/reverseOrderContinuity.test.js |
| [B-053](B-053-rival-gender-toggle-ignored-without-starter.md) | Docs viewer rival May/Brendan toggle is ignored until a starter is picked (all 6 rival cards shown) | fixed | minor | 0.6.0 | 0.6.0 | visual-tests/interaction.spec.mjs |
