...
| [B-012](B-012-delivery-optimistic-building-flash.md) | Delivery panel flashes "Building your ROM" before the server confirms (then flips to "Queued") | fixing | minor | 0.4.0 |  |  |
| [B-013](B-013-build-progress-resets-on-reload-client-synthesized.md) | Build progress + ETA reset to zero on reload (computed client-side, not from the backend) | fixing | major | 0.4.0 |  | backend/__tests__/produce.test.js |
