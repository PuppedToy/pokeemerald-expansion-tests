...
- [research/trapping.md](research/trapping.md) — **SSOT for the Perish-trap gimmick** (Shadow Tag + Perish Song, doubles); also records the T-124 decisions that terrains (misty/grassy/psychic) are soft surger-aware not gimmicks, and screens stay a light role (T-124)
