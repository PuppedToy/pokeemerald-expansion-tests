...
#define B_OBEDIENCE_DISABLED            TRUE       // If TRUE, the disobedience mechanic is removed entirely: every Pokémon always obeys, whatever its level, met level, Badge count or origin. Overrides B_OBEDIENCE_MECHANICS.
