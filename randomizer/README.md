...
randomize_and_make.sh
  └─ node ./randomizer/index.js     ← parses source, rebalances, writes game files + HTML
...
- `randomizer/output/out.html` — standalone viewer (template + inlined JS data)
- `randomizer/output/pokes.js`, `moves.js`, `abilities.js`, `trainers.js`, `wildpokes.js` — data modules
- `randomizer/pokes.json`, `moves.json`, `abilities.json`, `level_up_learnsets.json`, `teachable_learnsets.json`, `evoTree.json` — JSON snapshots
