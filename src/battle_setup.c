...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CHAMPION_STEVEN] = REMATCH(TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, MAP_EVER_GRANDE_CITY),
};
