...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TYPHLOSION_HISUI, CONDITIONS({IF_MIN_LEVEL, 25})}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_SUNFLORA}),
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_HONCHKROW}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MISMAGIUS}),
    #endif
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_GLISCOR}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_WEAVILE}),
    #endif
    },
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DUSK_STONE, SPECIES_URSALUNA, CONDITIONS({IF_MIN_LEVEL, 25})},
                                {EVO_ITEM, ITEM_MOON_STONE, SPECIES_URSALUNA_BLOODMOON, CONDITIONS({IF_MIN_LEVEL, 25})}),
    #endif
    },
