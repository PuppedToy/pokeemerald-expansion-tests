...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_LUDICOLO}),
    },
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SHIFTRY}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_GARDEVOIR}
                                ...
                                ,{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_GALLADE, CONDITIONS({IF_MIN_LEVEL, 25})}
                            #endif
                            ),
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_ROSERADE}),
    #endif
    },
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MILOTIC}),
    },
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_GLALIE}
                            #if P_GEN_4_CROSS_EVOS
                                ,{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_FROSLASS, CONDITIONS({IF_MIN_LEVEL, 25})}
                            #endif
                            ),
    },
