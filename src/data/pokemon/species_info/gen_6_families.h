...
#define FLOETTE_NORMAL_INFO(form, FORM, iconPal)                                                \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_FLORGES_ ##FORM}),\
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_MEOWSTIC_M, CONDITIONS({IF_MIN_LEVEL, 25})},
                                {EVO_LEVEL, 28, SPECIES_MEOWSTIC_F}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                {EVO_ITEM, ITEM_ICE_STONE, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_MIN_LEVEL, 25})}),
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG},
                                {EVO_ITEM, ITEM_ICE_STONE, SPECIES_AVALUGG_HISUI, CONDITIONS({IF_MIN_LEVEL, 25})}),
    },
