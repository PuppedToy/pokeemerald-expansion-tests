...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_OINKOLOGNE_M, CONDITIONS({IF_MIN_LEVEL, 25})},
                                {EVO_LEVEL, 18, SPECIES_OINKOLOGNE_F}),
    },
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_ARMAROUGE},
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_BELLIBOLT}),
    },
    ...
    [SPECIES_CETODDLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_CETITAN}),
    },
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_SINISTCHA_UNREMARKABLE}),
    ...
    [SPECIES_POLTCHAGEIST_ARTISAN] =
    {
        ...
        .levelUpLearnset = sPoltchageistLevelUpLearnset,
        .teachableLearnset = sPoltchageistTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_SINISTCHA_MASTERPIECE}),
        .formSpeciesIdTable = sPoltchageistFormSpeciesIdTable,
    },
