...
{
    {COMPOUND_STRING("Damp Rock")},
    {COMPOUND_STRING("Heat Rock")},
    {COMPOUND_STRING("Smooth Rock")},
    {COMPOUND_STRING("Icy Rock")},
};

static const struct MenuAction MultichoiceList_Route109HueyPickTM[] =
{
...
static const struct MenuAction MultichoiceList_Route110Pick[] =
{
    ...
    {COMPOUND_STRING("TM Earthquake")},
    {COMPOUND_STRING("TM Focus Punch")},
};

static const struct MenuAction MultichoiceList_Route110PickSeed[] =
{
    {COMPOUND_STRING("Electric Seed")},
    {COMPOUND_STRING("Grassy Seed")},
    {COMPOUND_STRING("Misty Seed")},
    {COMPOUND_STRING("Psychic Seed")},
};

static const struct MenuAction MultichoiceList_Route117PickScreen[] =
{
    {COMPOUND_STRING("TM Reflect")},
    {COMPOUND_STRING("TM Light Screen")},
};
...
static const struct MenuAction MultichoiceList_Route117PickPlate[] =
{
...
static const struct MenuAction MultichoiceList_Route118PickTM2[] =
{
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
...
static const struct MenuAction MultichoiceList_Route118PickTM3[] =
{
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
...
static const struct MenuAction MultichoiceList_Route121PickTM2[] =
{
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
...
{
    {COMPOUND_STRING("Choice Scarf")},
    {COMPOUND_STRING("Choice Band")},
    {COMPOUND_STRING("Choice Specs")},
};
...
static const struct MenuAction MultichoiceList_Route110PickExtender[] =
{
    {COMPOUND_STRING("Item 1")},
...
static const struct MenuAction MultichoiceList_Route106PickBall[] =
{
...
static const struct MenuAction MultichoiceList_Route125PickTM[] =
{
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
    {COMPOUND_STRING("TM Placeholder")},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_ROUTE118_PICK_TM2]          = MULTICHOICE(MultichoiceList_Route118PickTM2),
    [MULTI_ROUTE120_PICK_ITEM]         = MULTICHOICE(MultichoiceList_Route120PickItem),
    [MULTI_ROUTE121_PICK_TM]           = MULTICHOICE(MultichoiceList_Route121PickTM),
    [MULTI_ROUTE121_PICK_BERRY]        = MULTICHOICE(MultichoiceList_Route121PickBerry),
    [MULTI_ROUTE124_PICK_CHOICE]       = MULTICHOICE(MultichoiceList_Route124PickChoice),
    [MULTI_ROUTE124_PICK_TM]           = MULTICHOICE(MultichoiceList_Route124PickTM),
    ...
    [MULTI_ROUTE106_PICK_BALL]         = MULTICHOICE(MultichoiceList_Route106PickBall),
    ...
    [MULTI_ROUTE121_PICK_TM2]         = MULTICHOICE(MultichoiceList_Route121PickTM2),
    [MULTI_ROUTE125_PICK_TM]          = MULTICHOICE(MultichoiceList_Route125PickTM),
};
