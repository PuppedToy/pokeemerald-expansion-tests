...
const u8 gText_MoveRelearnerBattleMoves[] = _("BATTLE"); // T-167: shortened so the relearn price fits on the right.
const u8 gText_MoveRelearnerContestMovesTitle[] = _("CONTEST"); // T-167: shortened (was "CONTEST MOVES").
